...
class NavigationViewActivity : AppCompatActivity(), OnNavigationReadyCallback,
    ...
    private fun getDirectionsRoute(): DirectionsRoute {
        val directionsRouteAsJson = """
            {"routeIndex":"0","distance":346.761,"duration":46.641,"geometry":"w_z`cAgliriG|^~RdmAvl@fSnIr`@bQ`HvDbBz@","weight":46.641,"weight_name":"routability","legs":[{"distance":346.761,"duration":46.641,"summary":"C1","steps":[{"distance":257.09,"duration":14.36,"geometry":"w_z`cAgliriG|^~RdmAvl@fSnI","name":"首都高速都心環状線 (C1)","ref":"C1","mode":"driving","maneuver":{"location":[139.777237,35.681805],"bearing_before":0.0,"bearing_after":207.0,"instruction":"Head southwest on C1","type":"depart"},"voiceInstructions":[{"distanceAlongGeometry":257.09,"announcement":"Head southwest on C1, then take the ramp towards 宝町出口","ssmlAnnouncement":"\u003cspeak\u003e\u003camazon:effect name\u003d\"drc\"\u003e\u003cprosody rate\u003d\"1.08\"\u003eHead southwest on \u003csay-as interpret-as\u003d\"address\"\u003eC1\u003c/say-as\u003e, then take the ramp towards 宝町出口\u003c/prosody\u003e\u003c/amazon:effect\u003e\u003c/speak\u003e"}],"bannerInstructions":[{"distanceAlongGeometry":257.09,"primary":{"text":"宝町出口","components":[{"text":"宝町出口","type":"text"}],"type":"off ramp","modifier":"left"},"view":{"text":"","components":[{"text":"","type":"guidance-view","imageURL":"https://api.mapbox.com/guidance-views/v1/1580515200/jct/CB211101?arrow_ids\u003dCB21110A"}],"type":"off ramp","modifier":"left"}}],"driving_side":"left","weight":14.36,"intersections":[{"location":[139.777237,35.681805],"bearings":[207],"classes":["toll","motorway"],"entry":[true],"out":0},{"location":[139.776184,35.680042],"bearings":[24,203],"classes":["toll","motorway"],"entry":[false,true],"in":0,"out":1}]},{"distance":89.671,"duration":32.282,"geometry":"k}u`cA_`griGr`@bQ`HvDbBz@","name":"","destinations":"宝町出口","mode":"driving","maneuver":{"location":[139.776016,35.679718],"bearing_before":203.0,"bearing_after":203.0,"instruction":"Take the ramp towards 宝町出口","type":"off ramp","modifier":"slight left"},"voiceInstructions":[{"distanceAlongGeometry":13.9,"announcement":"You have arrived at your destination","ssmlAnnouncement":"\u003cspeak\u003e\u003camazon:effect name\u003d\"drc\"\u003e\u003cprosody rate\u003d\"1.08\"\u003eYou have arrived at your destination\u003c/prosody\u003e\u003c/amazon:effect\u003e\u003c/speak\u003e"}],"bannerInstructions":[{"distanceAlongGeometry":89.671,"primary":{"text":"You will arrive","components":[{"text":"You will arrive","type":"text"}],"type":"arrive","modifier":"straight"}},{"distanceAlongGeometry":13.9,"primary":{"text":"You have arrived","components":[{"text":"You have arrived","type":"text"}],"type":"arrive","modifier":"straight"}}],"driving_side":"left","weight":32.282,"intersections":[{"location":[139.776016,35.679718],"bearings":[23,203,207],"classes":["toll","motorway"],"entry":[false,true,true],"in":0,"out":1}]},{"distance":0.0,"duration":0.0,"geometry":"qot`cAgffriG??","name":"","mode":"driving","maneuver":{"location":[139.775604,35.678986],"bearing_before":207.0,"bearing_after":0.0,"instruction":"You have arrived at your destination","type":"arrive"},"voiceInstructions":[],"bannerInstructions":[],"driving_side":"left","weight":0.0,"intersections":[{"location":[139.775604,35.678986],"bearings":[27],"entry":[true],"in":0}]}],"annotation":{"distance":[63.9,154.2,39.2,65.4,18.1,6.2],"congestion":["unknown","unknown","unknown","unknown","unknown","unknown"]}}],"routeOptions":{"baseUrl":"https://api.mapbox.com","user":"mapbox","profile":"driving-traffic","coordinates":[[139.7772481,35.6818019],[139.7756523,35.6789722]],"alternatives":true,"language":"en","continue_straight":false,"roundabout_exits":false,"geometries":"polyline6","overview":"full","steps":true,"annotations":"congestion,distance","voice_instructions":true,"banner_instructions":true,"voice_units":"imperial","access_token":"pk.eyJ1IjoiZHJpdmVyYXBwLXplbnJpbiIsImEiOiJjazZsYjc4aHkwOGFjM2VwYjhoemI3dzRrIn0.mkSVeaFFNVPGyUmEzTFz_g","uuid":"RbDK4CEP0nCFXxfVEYjDbb7KiGC5OfbMsfKct749gu6te9LYQsF8qw\u003d\u003d"},"voiceLocale":"en-US"}
        """.trimIndent()
